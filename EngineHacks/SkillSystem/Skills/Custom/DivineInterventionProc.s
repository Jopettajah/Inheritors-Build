...
.macro blh to, reg=r3
  ...
  .short 0xf800
.endm
.equ DivineInterventionID, SkillTester+4
...
lsl r1, #8 @0xC000
@add r1, #2 @miss, only proc on miss
tst r0, r1
bne End 
...
@check for DivineIntervention proc
ldr r0, SkillTester
mov lr, r0
mov r0, r4 @attacker data
ldr r1, DivineInterventionID
.short 0xf800
cmp r0, #0
beq End
